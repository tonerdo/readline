...
namespace ReadLine.Tests
{
    public class KeyHandlerTests
    {
        public KeyHandlerTests()
        {
            ...
            "Hello".Select(c => c.ToConsoleKeyInfo()).ToList().ForEach(_keyHandler.Handle);
        }
        ...
        {
            " N".Select(c => c.ToConsoleKeyInfo()).Prepend(CtrlB).ToList().ForEach(_keyHandler.Handle);
        ...
        {
            Enumerable.Repeat(LeftArrow, 4).Append(CtrlD).ToList().ForEach(_keyHandler.Handle);
        ...
        {
            Enumerable.Repeat(UpArrow, _history.Count).ToList().ForEach(_keyHandler.Handle);
        ...
        {
            Enumerable.Repeat(LeftArrow, 3).ToList().ForEach(_keyHandler.Handle);
        ...
        {
            " World".Select(c => c.ToConsoleKeyInfo()).Append(CtrlW).ToList().ForEach(_keyHandler.Handle);
        ...
        {
            " N".Select(c => c.ToConsoleKeyInfo()).Prepend(LeftArrow).ToList().ForEach(_keyHandler.Handle);
        ...
        public void TestWriteChar()
        {
            ...
            " World".Select(c => c.ToConsoleKeyInfo()).ToList().ForEach(_keyHandler.Handle);
